...
import type { ZoomAuthorityFailure, ZoomFactor } from '#core/application/zoom/zoomAuthority.ts';
import { loadZoomPreference, saveZoomPreference } from '#core/infrastructure/preferences/zoomPreference.ts';
