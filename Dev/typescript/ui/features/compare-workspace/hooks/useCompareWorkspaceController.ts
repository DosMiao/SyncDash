...
import { listIdentical, maskMatch } from '#core/infrastructure/tauri/commands/compare.ts';
import { effectiveOperation } from '#core/domain/compare/plan.ts';
import { isMaskMatchResult } from '#core/domain/compare/runScope.ts';
import {
  type CompareWorkspace,
} from '#core/application/compare-workspace/compareWorkspaceModel.ts';
import { advancedFilterMasksEqual } from '#core/application/compare-workspace/compareWorkspaceFilters.ts';
