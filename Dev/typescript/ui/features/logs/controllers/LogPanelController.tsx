...
import { formatLogTimestamp } from '#core/shared/format.ts';
import { logArtifact, logRuns, revealLogLocation } from '#core/infrastructure/tauri/commands/logs.ts';
import {
  ...
  runHasArtifactSet,
  runHasEventArtifact,
} from '#core/domain/runs/logs.ts';
import type { LogArtifactView, LogLevelFilter, LogRow } from '#core/domain/runs/logs.ts';
...
export function LogPanelController({ jobId, onClose, onSettings, onStatus, reloadKey }: LogPanelProps) {
